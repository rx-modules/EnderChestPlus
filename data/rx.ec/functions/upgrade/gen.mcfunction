...
execute unless entity af-0-0-0-1 run summon minecraft:armor_stand -30000000 60 1602 {CustomName:'{"text":"Rx Stand"}',NoGravity:1b,Silent:1b,Invulnerable:1b,UUID:[I;175,0,0,1],CustomNameVisible:0b,NoAI:1b,AbsorptionAmount:1e8f, Marker:1b, Small:1b, ShowArms:1b, Invisible:1b,HandItems:[{id:"stick",Count:1b,tag:{Enchantments:[{id:"minecraft:aqua_affinity",lvl:1}]}},{}]}
